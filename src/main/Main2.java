...
public class Main2
{
	...
	public static JLabel r, textDiceRoller, labelStrMod, labelDexMod, labelConMod, labelIntMod, labelWisMod, labelChaMod;
	...
	public static void main(String[] args)
	{
		...
		JLabel t = new JLabel();
		t.setFont(title);
		Stats.generateStats(); // Generate Character Stats
		t.setText("<html>Your STR score is<BR>Your DEX score is<BR>Your CON score is<BR>Your INT score is<BR>Your WIS score is<BR>Your CHA score is </html>");

		//Roll text
		r = new JLabel();
		r.setFont(text);
		r.setText("Hit Roll to roll a die!");
...
//				t.setText("<html>Your STR score is " + Stats.getStrength() + "<BR>Your DEX score is "
//						+ Stats.getDexterity() + "<BR>Your CON score is " + Stats.getConstitution()
//						+ "<BR>Your INT score is " + Stats.getIntelligence() + "<BR>Your WIS score is "
//						+ Stats.getWisdom() + "<BR>Your CHA score is " + Stats.getCharisma() + "</html>");
			}
		});
		...
		//Rolling Section
//		rightPanel.add(new JLabel("<html>Dice Roller&#9;Test</html>"));
	...
	public static void createRoller()
	{
		rolls.add(r);
